...
<!-- END INCLUDE HEADER -->
  ...
  <div class="container">
    ...
    <h4 class="font-regular mb-4">“ Tambah Vendor</h4>
    <div class="row">
      <div class="col-sm-7">
        <div class="card-detail mb-5">
          ...
          <div class="d-flex align-items-center mb-2">
            <h1 class="color-primary">Rp. {{ number_format(7800000,2) }}</h1>
      ...
      <div class="col-sm-5">
        <div class="card-profile mb-5">
          ...
          <h4 class="text-ptserif text-center mb-2">PT Jaya Bersama</h4>
          <h5 class="text-secondary mb-4">Jl paku haji 5</h5>
